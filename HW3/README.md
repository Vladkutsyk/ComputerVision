...
2. **Згортка 1×1 (Network in Network)** — виконує міжканальну нелінійну проекцію без зміни просторових розмірів; зменшує кількість каналів перед дорогими 3×3 операціями.
